...
class _LotteryScreenState extends State<LotteryScreen> {
  ...
  final Map<String, List<Map<String, String>>> exercises = {
    ...
    "캐딜락 운동": [
      {"name": "ROLL DOWN-BASIC", "page": "3"},
      {"name": "ROLL DOWN-EXTENSION", "page": "5"},
      {"name": "ROLL DOWN-TWIST OBLIQUE", "page": "7"},
      {"name": "SIDE BEND", "page": "9"},
      {"name": "BRIDGE-ROLL DOWN BAR", "page": "11"},
      {"name": "Single leg hip bridge", "page": "13"},
      {"name": "BRIDGE-PUSH THROUGH BAR", "page": "14"},
      {"name": "PUSH THROUGH WITH ROLL UP", "page": "16"},
      {"name": "PUSH UP", "page": "18"},
      {"name": "Forward lean Plank", "page": "20"},
      {"name": "SCAPULAR MOVEMENT SUPINE", "page": "21"},
      {"name": "SCAPULAR MOVEMENT SITTING", "page": "23"},
      {"name": "FORWARD PUSH THRU", "page": "25"},
      {"name": "FORWARD PUSH THRU-KNEEING POSITION", "page": "27"},
      {"name": "SAW", "page": "29"},
      {"name": "MERMAID 1", "page": "31"},
      {"name": "MERMAID 2", "page": "32"},
      {"name": "MERMAID 3", "page": "33"},
      {"name": "LATISSIMUS DORSI", "page": "35"},
      {"name": "Kneeling Lat press", "page": "37"},
      {"name": "PULL UP", "page": "38"},
      {"name": "SPREAD EAGLE", "page": "40"},
      {"name": "SPREAD EAGLE-single leg variation", "page": "42"},
      {"name": "Fuzzy-inverted row", "page": "43"},
      {"name": "Fuzzy-Plank", "page": "44"},
      {"name": "TEASER", "page": "45"},
      {"name": "SWAN", "page": "48"},
      {"name": "HIGH SWAN", "page": "50"},
      {"name": "PUSH THROUGH BRIDGE", "page": "52"},
      {"name": "PUSH THROUGH-LIFT PELVIS", "page": "54"},
      {"name": "WATER SKI", "page": "56"},
      {"name": "LEG PRESS", "page": "58"},
      {"name": "ONE LEG PRESS", "page": "60"},
      {"name": "SIDE LEG PRESS", "page": "62"},
      {"name": "MONKEY", "page": "64"},
      {"name": "TOWER", "page": "66"},
      {"name": "HIP EXTENSION", "page": "68"},
      {"name": "KNEE KICK STRAP", "page": "70"},
      {"name": "SKY WALK", "page": "72"},
      {"name": "AIR BRIDGE", "page": "74"},
      {"name": "BODY DROP", "page": "76"},
      {"name": "Supine heel tap series", "page": "78"},
      {"name": "Chest press", "page": "79"},

...
class _LotteryScreenState extends State<LotteryScreen> {
  ...
  final Map<String, List<Map<String, String>>> exercises = {
    ...
    "캐딜락 운동": [
      {"name": "ROLL DOWN-BASIC", "page": "0"},
      {"name": "ROLL DOWN-EXTENSION", "page": "0"},
      {"name": "ROLL DOWN-TWIST OBLIQUE", "page": "0"},
      {"name": "SIDE BEND", "page": "0"},
      {"name": "BRIDGE-ROLL DOWN BAR", "page": "0"},
      {"name": "Single leg hip bridge", "page": "0"},
      {"name": "BRIDGE-PUSH THROUGH BAR", "page": "0"},
      {"name": "PUSH THROUGH WITH ROLL UP", "page": "0"},
      {"name": "PUSH UP", "page": "0"},
      {"name": "Forward lean Plank", "page": "0"},
      {"name": "SCAPULAR MOVEMENT SUPINE", "page": "0"},
      {"name": "SCAPULAR MOVEMENT SITTING", "page": "0"},
      {"name": "FORWARD PUSH THRU", "page": "0"},
      {"name": "FORWARD PUSH THRU-KNEEING POSITION", "page": "0"},
      {"name": "SAW", "page": "0"},
      {"name": "MERMAID 1", "page": "0"},
      {"name": "MERMAID 2", "page": "0"},
      {"name": "MERMAID 3", "page": "0"},
      {"name": "LATISSIMUS DORSI", "page": "0"},
      {"name": "Kneeling Lat press", "page": "0"},
      {"name": "PULL UP", "page": "0"},
      {"name": "SPREAD EAGLE", "page": "0"},
      {"name": "SPREAD EAGLE-single leg variation", "page": "0"},
      {"name": "Fuzzy-inverted row", "page": "0"},
      {"name": "Fuzzy-Plank", "page": "0"},
      {"name": "TEASER", "page": "0"},
      {"name": "SWAN", "page": "0"},
      {"name": "HIGH SWAN", "page": "0"},
      {"name": "PUSH THROUGH BRIDGE", "page": "0"},
      {"name": "PUSH THROUGH-LIFT PELVIS", "page": "0"},
      {"name": "WATER SKI", "page": "0"},
      {"name": "LEG PRESS", "page": "0"},
      {"name": "ONE LEG PRESS", "page": "0"},
      {"name": "SIDE LEG PRESS", "page": "0"},
      {"name": "MONKEY", "page": "0"},
      {"name": "TOWER", "page": "0"},
      {"name": "HIP EXTENSION", "page": "0"},
      {"name": "KNEE KICK STRAP", "page": "0"},
      {"name": "SKY WALK", "page": "0"},
      {"name": "AIR BRIDGE", "page": "0"},
      {"name": "BODY DROP", "page": "0"},
      {"name": "Supine heel tap series", "page": "0"},
      {"name": "Chest press", "page": "0"},
      {"name": "ADDUCTOR STRETCHING-TRAPEZE", "page": "0"},
      {"name": "ADDUCTOR STRETCHING-FUZZY", "page": "0"},
      {"name": "HAMSTRING STRETCHING", "page": "0"},
      {"name": "SIDE LEG series-HIP EXTENSION 1", "page": "0"},
      {"name": "SIDE LEG series-HIP EXTENSION 2", "page": "0"},
      {"name": "SIDE LEG series-HIP EXTENSION 3", "page": "0"},
      {"name": "SIDE LEG series-LEG CIRCLE", "page": "0"},
      {"name": "ARM SERIES-ROWING", "page": "0"},
      {"name": "ARM SERIES-BICEPS CURLS", "page": "0"},
      {"name": "HUNDRED", "page": "0"}
    ]
  };
